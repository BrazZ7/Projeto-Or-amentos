      ...
      <QuickClientModal
        ...
        onCreated={(client) => {
          setClientOptions((prev) =>
            [...prev, client].sort((a, b) => a.name.localeCompare(b.name, 'pt-BR')),
          );
          ...
          <CardContent className="grid gap-4 sm:grid-cols-3">
            <div className="sm:col-span-1">
              ...
              <button
                ...
                className="mt-1.5 inline-flex items-center gap-1.5 text-xs font-medium text-brand-400 transition-colors hover:text-brand-300"
              >
